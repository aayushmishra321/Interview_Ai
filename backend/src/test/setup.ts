...
jest.mock('../services/redis', () => ({
  __esModule: true,
  default: {
    isHealthy: jest.fn().mockReturnValue(false), // Redis not available in tests
    isConnected: jest.fn().mockReturnValue(false),
    get: jest.fn().mockResolvedValue(null),
    set: jest.fn().mockResolvedValue(false), // Returns boolean, not 'OK'
    del: jest.fn().mockResolvedValue(false), // Returns boolean
    exists: jest.fn().mockResolvedValue(false),
    setJSON: jest.fn().mockResolvedValue(false),
    getJSON: jest.fn().mockResolvedValue(null),
    increment: jest.fn().mockResolvedValue(0),
    addToSet: jest.fn().mockResolvedValue(false),
    isInSet: jest.fn().mockResolvedValue(false),
...
// Global test cleanup to prevent Jest from hanging
afterAll(async () => {
