...
export function HistoryPage() {
  ...
  useEffect(() => {
    ...
    console.log('Current interviews in store:', interviews);
  ...
  const fetchHistory = async () => {
    try {
      console.log('Calling getInterviewHistory...');
      await getInterviewHistory();
      // After the promise resolves, the store will be updated
      // and the component will re-render with new interviews
      console.log('✅ Interview history fetch complete');
    } catch (error: any) {
  ...
  // Log whenever interviews change
  useEffect(() => {
    console.log('Interviews updated in store:', interviews.length, 'interviews');
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                        ...
                        <span className="flex items-center gap-1">
                          ...
                          {(interview as any).session?.actualDuration || interview.settings?.duration || 0} min
                        </span>
                        {interview.analysis && (
                        ...
                        <span className="text-xs">
                          Questions: {interview.responses?.length || 0}/{interview.questions?.length || 0}
                        </span>
                      </div>
                    </div>
